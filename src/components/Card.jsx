    ...
    <>
      <div className="hover:shadow-lg transition duration-450 ease-in-out w-full h-full md:w-[500px] md:h-[750px] rounded-lg border dark:bg-slate-600 dark:text-white border-blue-500 p-5">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-white mb-2 border-t pt-4">
              Tecnologías{" "}
            </h4>
            <div className="flex flex-wrap h-30 gap-4 justify-center items-center">
